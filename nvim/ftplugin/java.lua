        ...
        java = {
            ...
            configuration = {
                ...
                runtimes = {
                    ...
                    { name = "JavaSE-17", path = vim.env.HOME .. "/.local/share/mise/installs/java/temurin-17.0.13+11" },
                    { name = "JavaSE-21", path = vim.env.HOME .. "/.local/share/mise/installs/java/temurin-21.0.5+11.0.LTS" },
                }
            },
            maven = {
                downloadSources = true,
